...
export default function ProductSkeleton() {
  return (
    <div className="bg-zinc-900/35 border border-zinc-800/80 rounded-2xl p-5 space-y-4 animate-pulse select-none">
      {/* Product Image */}
      <div className="aspect-square bg-zinc-800/60 rounded-xl w-full" />
      {/* Brand & Title */}
      <div className="space-y-2">
        <div className="h-3 w-16 bg-zinc-800/60 rounded" />
        <div className="h-5 w-4/5 bg-zinc-800/60 rounded" />
      </div>
