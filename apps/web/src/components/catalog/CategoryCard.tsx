  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="flex items-center text-xs font-semibold text-zinc-400 group-hover:text-[#D71920] transition-colors">
      ...
      <div className="mt-4">
        <h3 className="text-base font-bold text-zinc-900 group-hover:text-[#D71920] transition-colors">
          {category.name}
        </h3>
      ...
      {category.children && category.children.length > 0 && (
        <div className="flex flex-wrap gap-1.5 mt-4 pt-4 border-t border-zinc-100 group-hover:border-[#D71920]/10 transition-colors">
