    ...
    <div className="space-y-6">
      ...
      {addresses.length === 0 ? (
        <div className="text-center py-16 border border-dashed border-zinc-800 rounded-2xl bg-zinc-900/10">
          ...
          <h3 className="text-sm font-bold text-white">No Addresses Added</h3>
          ...
          {addresses.map((address) => (
            ...
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                <div>
                  <h4 className="font-bold text-sm text-white">{address.recipientName}</h4>
                  <p className="text-[11px] text-zinc-400 mt-0.5">{address.phone}</p>
                </div>
                {address.isDefault && (
              ...
              <div className="text-xs text-zinc-400 leading-relaxed min-h-[48px]">
              ...
              <div className="flex justify-end gap-2 border-t border-zinc-800/60 pt-3 mt-3">
                <Button
                  variant="secondary"
                  onClick={() => {
                ...
                <Button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] text-red-400 hover:text-red-300 hover:bg-red-500/10 border-red-500/10"
                >
